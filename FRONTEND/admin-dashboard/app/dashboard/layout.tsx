    ...
    return (
      ...
      `}>
                ...
                <div className="h-12 flex items-center px-4 border-b border-zinc-200 dark:border-white/[0.06] shrink-0">
                    <div>
                        <p className="text-[10px] font-semibold tracking-[0.2em] text-zinc-900 dark:text-white">
                            ADMIN
                        </p>
                        <p className="text-[9px] text-zinc-400 dark:text-zinc-600 tracking-[0.1em]">
                            MUSIC SOCIAL
                        </p>
                    </div>
                </div>
            ...
            <div className="flex-1 lg:ml-52 flex flex-col min-h-screen">
                ...
                <header className="h-12 border-b border-zinc-200 dark:border-white/[0.06] flex items-center px-4 gap-3 shrink-0 bg-white dark:bg-black">
                    <button
                        className="lg:hidden text-zinc-400 dark:text-zinc-600 hover:text-zinc-900 dark:hover:text-white transition-colors"
                ...
                {i > 0 && <span>/</span>}
                                <span className={i === arr.length - 1 ? 'text-zinc-600 dark:text-zinc-400' : ''}>
                  {seg}
                </span>
              </span>
                        ))}
                    ...
                    {/* Spacer + mobile theme toggle */}
                    <div className="ml-auto flex items-center lg:hidden">
                        <button
                            onClick={toggle}
                            className="text-zinc-400 dark:text-zinc-600 hover:text-zinc-900 dark:hover:text-white transition-colors p-1"
                        >
