...
const styles = StyleSheet.create({
    ...
    topBarTitle: { color: COLORS.white, fontSize: 22, fontWeight: '800', letterSpacing: -0.4 },
    gearBtn:     { padding: 8 },
    ...
    name: { color: COLORS.white, fontSize: 26, fontWeight: '800', marginBottom: 6, letterSpacing: -0.4 },
    email: { color: COLORS.glass45, fontSize: 14, marginBottom: 20, fontWeight: '500' },

    editBtn: {
        paddingHorizontal: 24, paddingVertical: 11,
        borderRadius: 999, borderWidth: 1,
        borderColor: COLORS.glass20, backgroundColor: COLORS.accentFill20,
    },
    editBtnText: { color: COLORS.accent, fontWeight: '700', fontSize: 15 },
    ...
    statItem:  { flex: 1, alignItems: 'center', paddingVertical: 20, borderRightWidth: 1, borderRightColor: COLORS.glass08 },
    statVal:   { color: COLORS.white, fontSize: 22, fontWeight: '800', letterSpacing: -0.3 },
    statLabel: { color: COLORS.glass50, fontSize: 12, marginTop: 4, fontWeight: '600' },
    ...
    menuCard: {
        ...
        backgroundColor: COLORS.surface,
        borderWidth: 1, borderColor: COLORS.glass12,
        elevation: 2,
        shadowColor: '#000',
        shadowOffset: { width: 0, height: 1 },
        shadowOpacity: 0.06,
    ...
    menuRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: COLORS.glass06 },
    menuIconWrap: {
    ...
    menuSub:   { color: COLORS.glass50, fontSize: 12, marginTop: 2, fontWeight: '500' },
    menuArrow: { color: COLORS.glass35, fontSize: 20 },
