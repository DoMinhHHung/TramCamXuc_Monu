// HomeScreen.tsx — kết nối với PlayerContext để play nhạc
...
export const HomeScreen = () => {
    ...
    // Khi nhấn vào bài → playSong với toàn bộ section làm queue
...
const SongCard = ({
    ...
    >
        <LinearGradient
            colors={isActive
                ? [COLORS.accentFill20, COLORS.accentFill20]
                : [COLORS.surface, COLORS.surfaceLow]}
