...
import iuh.fit.se.musicservice.entity.BaseEntity;
...
public class Playlist extends BaseEntity {
    ...
    /** userId từ identity-service — không join sang service khác */
    ...
    /**
     * Head của doubly linked list — trỏ tới PlaylistSong.id đầu tiên.
     * null khi playlist rỗng.
     */
