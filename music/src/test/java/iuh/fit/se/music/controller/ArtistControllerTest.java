...
class ArtistControllerTest {
    ...
    @Test void toggleArtistStatus(){ UUID id=UUID.randomUUID(); assertEquals("Artist status updated successfully", artistController.toggleArtistStatus(id, ArtistStatus.BANNED).getMessage()); verify(artistService).toggleArtistStatus(id, ArtistStatus.BANNED); }
}
